...
jnp.save("results/theta_opt_y3_arx_init_TR",jnp.array(theta_final))
jnp.save("results/costs_opt_y3_arx_init_TR",jnp.array(result.fun))
jnp.save("results/accuracy_y3_arx_init_TR",jnp.array(result.success))
jnp.save("results/times_y3_arx_init_TR",jnp.array(time.time() - startTime))
