...
# ----------------------------------------------------------------------
    ...
    np.save("results/cov/theta_opt_y3_100_rel_arx_init_TR",np.array(theta))
    np.save("results/cov/costs_opt_y3_100_rel_arx_init_TR",np.array(cost))
    np.save("results/cov/accuracy_y3_100_rel_arx_init_TR",np.array(accuracy))
